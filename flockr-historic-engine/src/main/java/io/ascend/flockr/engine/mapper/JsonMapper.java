package io.ascend.flockr.engine.mapper;
 ...
 *
 * <p>This class provides a centralized, thread-safe ObjectMapper instance for JSON operations
 * throughout the application. The ObjectMapper is configured with default settings suitable for
 * most use cases.
 *
 * <p><b>Usage:</b>
 *
 ...
 * <p><b>Thread Safety:</b>
 *
 * <p>The ObjectMapper instance is thread-safe and can be safely shared across multiple threads.
 *
