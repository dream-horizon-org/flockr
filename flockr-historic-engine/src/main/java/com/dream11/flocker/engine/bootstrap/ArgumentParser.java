 ...
 * <ul>
 *   <li>Parsing JSON command-line arguments into EngineArguments</li>
 *   <li>Validating all required fields are present and non-empty</li>
 *   <li>Providing helpful error messages when validation fails</li>
 * </ul>
 * 
...
public class ArgumentParser {
    ...
    private void validateArgumentsPresent(String[] args) {
        if (args.length < 1) {
            ...
            log.error("  - destinationJson: List of destination configurations as JSON array (optional, multiple destinations supported)");
            log.error("");
