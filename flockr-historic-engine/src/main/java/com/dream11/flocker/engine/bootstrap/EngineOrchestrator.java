 ...
 * <ol>
 *   <li>Validates action type</li>
 *   <li>Configures AWS credentials from source</li>
 *   <li>Configures internal sinks</li>
 *   <li>Creates Spark session</li>
 *   <li>Sets up dependency injection</li>
 *   <li>Executes the data processing pipeline</li>
 * </ol>
 * 
...
public class EngineOrchestrator {
     ...
     * 
     * <p>This method handles the complete lifecycle including SparkSession creation
     * and cleanup.
     * 
    ...
    public void execute(String[] args) throws Exception {
        ...
        try {
            ...
            ConnectorConfig sourceConnectorConfig = configConverter.convertSourceConfigToConnectorConfig(
                    sourceType, source.getConfig());
            ...
            AthenaConfig athenaConfig = awsCredentialsConfigurator.configureCredentials(sourceConnectorConfig);

            // Configure internal sinks
            sinkConfigs = internalSinkConfigurator.configureInternalSinks(
            ...
            Injector injector = Guice.createInjector(
                    new EngineModule(sparkSession, sourceConnectorConfig, sinkConfigs, 
                            audienceName, action, expireAt));
    ...
    private String validateAndNormalizeAction(String action) {
        ...
        if (!eventAction.equals(Constants.ACTION_APPEND) && !eventAction.equals(Constants.ACTION_REMOVE)) {
            throw new IllegalArgumentException(
                    String.format("Invalid action: %s. Valid values: %s, %s", 
