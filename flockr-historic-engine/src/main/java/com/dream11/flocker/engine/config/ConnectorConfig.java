 ...
 * 
 * <p>This class represents a type-safe wrapper around connector configurations.
 * It is used internally to represent both source and sink configurations in a
 * unified way. The actual configuration object type depends on the connector type.
 * 
 * <p><b>For Sources:</b>
 * <ul>
 *   <li>Type: "ATHENA", "S3", "KAFKA", etc.</li>
 *   <li>Config: AthenaConfig, S3Config, KafkaConfig, etc.</li>
 * </ul>
 * 
 * <p><b>For Sinks:</b>
 * <ul>
 *   <li>Type: "S3", "API", "KAFKA", etc.</li>
 *   <li>Config: S3Config, ApiConfig, KafkaProducerConfig, etc.</li>
 * </ul>
 * 
 * <p>This class uses a custom deserializer ({@link ConnectorConfigDeserializer})
 * to properly deserialize JSON configurations into the appropriate config objects.
 * 
...
public class ConnectorConfig {
     ...
     * <ul>
     *   <li>ATHENA → AthenaConfig</li>
     *   <li>S3 → S3Config</li>
     *   <li>API → ApiConfig</li>
     *   <li>KAFKA → KafkaConfig or KafkaProducerConfig</li>
     * </ul>
     * 
