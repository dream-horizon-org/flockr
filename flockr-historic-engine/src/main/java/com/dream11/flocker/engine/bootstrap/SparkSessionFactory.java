 ...
 * <ul>
 *   <li>Determining the Spark master URL (from system property or default)</li>
 *   <li>Loading Spark configuration from config files</li>
 *   <li>Creating and configuring SparkSession instances</li>
 * </ul>
 * 
...
public class SparkSessionFactory {
     ...
     * <p>This method:
     * <ol>
     *   <li>Determines Spark master URL (from system property or default)</li>
     *   <li>Loads Spark configuration from config files</li>
     *   <li>Applies configuration to SparkSession builder</li>
     *   <li>Creates and returns the SparkSession</li>
     * </ol>
     * 
    ...
    private String getSparkMaster() {
        return System.getProperty(Constants.KEY_SPARK_MASTER,
