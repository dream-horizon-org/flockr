 ...
 * <ul>
 *   <li>Creating internal S3 sink configuration with credentials from source</li>
 *   <li>Creating internal API sink configuration</li>
 *   <li>Adding these sinks to the sink configurations list</li>
 * </ul>
 * 
 * <p><b>Internal Sinks:</b>
 * <ul>
 *   <li><b>S3 Sink</b>: Always added at the beginning of the list for data persistence</li>
 *   <li><b>API Sink</b>: Always added at the end for external API notifications</li>
 * </ul>
 * 
...
public class InternalSinkConfigurator {
     ...
     * <p>This method:
     * <ol>
     *   <li>Creates internal S3 sink with credentials from source (if available)</li>
     *   <li>Adds S3 sink at the beginning of the list</li>
     *   <li>Creates internal API sink with default configuration</li>
     *   <li>Adds API sink at the end of the list</li>
     * </ol>
     * 
     ...
     */
    public List<ConnectorConfig> configureInternalSinks(List<ConnectorConfig> sinkConfigs, 
     ...
     */
    private void copyCredentialsToS3Config(S3Config internalS3Config, 
                                           AthenaConfig athenaConfig,
                                           ConnectorConfig sourceConnectorConfig) {
        ...
        } else if (sourceConnectorConfig != null && "S3".equalsIgnoreCase(sourceConnectorConfig.getType())) {
            S3Config sourceS3Config = (S3Config) sourceConnectorConfig.getConfig();
            if (sourceS3Config != null && sourceS3Config.getAccessKey() != null 
                ...
                if (sourceS3Config.getSessionToken() != null && !sourceS3Config.getSessionToken().isEmpty()) {
