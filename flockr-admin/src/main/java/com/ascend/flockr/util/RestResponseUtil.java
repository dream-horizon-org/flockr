...
public final class RestResponseUtil {
  ...
  /**
   * Converts a Single<T> (normal data) into CompletionStage<Response<T>> wrapping success or error
   * into your Response model.
   */
    ...
    return single ->
        fromSingle(
            single
                ...
                .onErrorReturn(error -> Response.errorResponse(error.getMessage(), 500)));
  }
}
