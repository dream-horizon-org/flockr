...
public class ServiceModule extends DefaultModule {
  ...
  private void bindDAOs() {
    ...
    // Task repositories
    bind(com.ascend.flockr.repository.TaskRepository.class)
        .to(com.ascend.flockr.repository.impl.TaskRepositoryFacade.class);
    bind(com.ascend.flockr.repository.internal.TaskReadRepository.class)
        .to(com.ascend.flockr.repository.internal.impl.TaskReadRepositoryImpl.class);
    bind(com.ascend.flockr.repository.internal.TaskWriteRepository.class)
        .to(com.ascend.flockr.repository.internal.impl.TaskWriteRepositoryImpl.class);
  }

  private void bindServices() {
    bind(HealthCheckService.class).to(HealthCheckServiceImpl.class);
    bind(com.ascend.flockr.service.TaskService.class)
        .to(com.ascend.flockr.service.impl.TaskServiceImpl.class);
    bind(com.ascend.flockr.gateway.JobSchedulerGateway.class)
        .to(com.ascend.flockr.gateway.impl.NoopJobSchedulerGateway.class);
  }
}
