 ...
 *
 * <p>This class extends Vert.x {@link Launcher} and provides a framework for initializing
 * Vert.x applications with Guice dependency injection. It handles common setup tasks such as:
 *
 * <ul>
...
public abstract class AbstractMainApplication extends Launcher {
     ...
     *
     * <p>This method throws an exception to prevent direct instantiation. Subclasses should
     * override this method and delegate to {@link #dispatch(String[])} instead.
     *
     ...
     *
     * <p>Sets the number of verticle instances to 1 by default. Subclasses can override this
     * method to customize deployment options.
     *
     ...
     *
     * <p>This method logs detailed error information about failed deployments and delegates to
     * the parent class for default error handling.
     *
...
//        VertxContextUtils.setInstanceInSharedData(vertx, new GuiceInjector());
     ...
     *
     * <p>Subclasses must implement this method to provide their application-specific Guice
     * modules. These modules will be used to configure the dependency injection container.
     *
