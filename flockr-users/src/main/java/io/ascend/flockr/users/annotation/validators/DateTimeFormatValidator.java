package io.ascend.flockr.users.annotation.validators;
 ...
 * io.ascend.flockr.users.constants.Constants#DATE_PATTERN} ("yyyy-MM-dd HH:mm:ss"). It uses the
 * {@link io.ascend.flockr.users.util.CommonUtils#getFormatter()} to parse the value.
 *
 ...
 * @since 1.0
 * @see DateTimeFormat
 * @see io.ascend.flockr.users.util.CommonUtils#getFormatter()
 */
public class DateTimeFormatValidator implements ConstraintValidator<DateTimeFormat, String> {
   ...
   * io.ascend.flockr.users.util.CommonUtils#getFormatter()}. If parsing succeeds, the value is
