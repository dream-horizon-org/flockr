package io.ascend.flockr.users.client;
 ...
 *
 * <p>The default implementation is {@link io.ascend.flockr.users.client.impl.AerospikeImpl}, which
 * uses the Aerospike Java client library.
 *
 * @author Sudhanshu Rai
 * @since 1.0
 * @see io.ascend.flockr.users.client.impl.AerospikeImpl
 */
