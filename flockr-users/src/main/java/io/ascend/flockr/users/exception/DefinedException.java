package io.ascend.flockr.users.exception;
 ...
 * io.ascend.flockr.users.exception.errors.DefinedErrors} with the REST framework's exception
 * handling.
 *
 * @author Sudhanshu Rai
 * @since 1.0
 * @see io.ascend.flockr.users.exception.errors.DefinedErrors
 */
